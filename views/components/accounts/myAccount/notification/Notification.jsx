...
const Notification = () => {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        const response = await axios.get(`https://773f-62-173-45-70.ngrok-free.app/api/v1/notifications/notification/userId`);
  ...
  const clearNotifications = async () => {
    try {
      await axios.delete(`https://773f-62-173-45-70.ngrok-free.app/api/v1/notifications/clear/userId`);
      setNotifications([]);
      setUnreadCount(0); // Reset unread count when clearing notifications
    } catch (error) {
  ...
  const markAsRead = async (notificationId) => {
    try {
      await axios.put(`https://773f-62-173-45-70.ngrok-free.app/api/v1/notifications/markAsRead/${notificationId}`);
